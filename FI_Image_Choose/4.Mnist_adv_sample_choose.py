...
sheet_id = 1  # train: 1 or 2   test: 3
FI_below = 0.01
prob_y_target = 0.01
situation = 1  
...
if target_not_given == False:
    ...
    dic_mnist,count_num = adv_select_without_target(sheet_id =sheet_id ,FI_below=FI_below,situation = situation,prob_y_target= prob_y_target)
print(count_num) 
