...
y_train = np.load('/your_path_to_main_dir/FI_Image_Choose/Mnist_train_label.npy')                        # (60000, 10)

## test_set
x_test = np.load('/your_path_to_main_dir/FI_Image_Choose/Mnist_set/Mnist_test_image.npy').reshape(-1,28,28,1)   # (10000, 28 28, 1)
y_test = np.load('/your_path_to_main_dir/FI_Image_Choose/Mnist_set/Mnist_test_label.npy')
