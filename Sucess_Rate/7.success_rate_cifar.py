...
print("original trained resenet 32 tested on adversarial test image loss, test acc:", test_result)
...
subset_of_success_x = [x_train[i].reshape(1,32,32,3) for i in indices ]
